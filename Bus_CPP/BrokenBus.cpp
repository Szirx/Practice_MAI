...
//конструктор
BrokenBus::BrokenBus(int InitX1, int InitY1) : Bus(InitX1, InitY1)
{

}//end BrokenBus::BrokenBus()

//деструктор
BrokenBus::~BrokenBus(void)  //формально пустое тело
{

}//end BrokenBus::~BrokenBus()

//вывод фигуры в консоль
void BrokenBus::Show(void)
{
	Visible = true;
	Bus::Show();	//рисуем фигуру предка
...
void BrokenBus::Hide(void)
{
	Visible = false;
	Bus::Hide(); //стираем фигуру предка
	//зададим цвет пера белый
